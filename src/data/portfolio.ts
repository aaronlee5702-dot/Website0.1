...
export const projects: Project[] = [
  {
    ...
    detailedDescription: 'The purpose of the 6-axis robotic arm was to test the limits and understanding of automated manufacturing. Created the physical structures and gears using SolidWorks. Used the CAD files to 3D print and manufacture the parts. Finally, I used Arduino software and hardware to control the arm remotely. This project tested my design, CAD, circuitry, and software skills.',
